    ...
    <div className="relative min-h-screen bg-slate-50 text-slate-900 flex overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none" aria-hidden="true">
        ...
        <svg className="absolute inset-0 h-full w-full stroke-slate-200/80 [mask-image:radial-gradient(100%_100%_at_top,white,transparent)]">
          ...
          <rect width="100%" height="100%" strokeWidth="0" fill="url(#analytics-grid)" />
        </svg>
      ...
      <aside className="relative z-10 w-64 border-r border-slate-200/80 bg-white/80 backdrop-blur-md flex flex-col justify-between p-6">
        <div className="space-y-8">
          ...
          <nav className="space-y-1">
            <Link to="/" className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-slate-600 hover:text-slate-900 hover:bg-slate-100 transition-all">
              <Home className="w-4 h-4" />
              Landing Page
            </Link>
            <Link to="/analytics" className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold bg-indigo-50 border border-indigo-100 text-indigo-600">
              <LayoutDashboard className="w-4 h-4" />
              Workspace
            </Link>
            <div className="opacity-60 cursor-not-allowed flex items-center justify-between px-4 py-3 rounded-xl text-sm font-medium text-slate-400">
              <span className="flex items-center gap-3">
                <Database className="w-4 h-4" />
                Data Manager
              </span>
              <span className="text-[9px] font-mono bg-slate-100 text-slate-500 px-1.5 py-0.5 rounded">Soon</span>
            </div>
            <div className="opacity-60 cursor-not-allowed flex items-center justify-between px-4 py-3 rounded-xl text-sm font-medium text-slate-400">
              <span className="flex items-center gap-3">
        ...
        <div className="space-y-4 pt-6 border-t border-slate-100">
          {user && (
            <div className="px-2">
              <p className="text-[10px] text-slate-400 font-mono tracking-wider">AUTHENTICATED NODE</p>
      ...
      <main className="relative z-10 flex-1 flex flex-col">
        ...
        <header className="h-16 border-b border-slate-200/60 bg-white/40 backdrop-blur-md flex items-center justify-between px-8">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] text-slate-500 font-mono tracking-wider">LIVE NODE SYSTEM STREAM</span>
          </div>
          <Link 
            to="/"
          ...
          <div className="w-full max-w-2xl text-center space-y-8 p-8 md:p-12 rounded-3xl border border-slate-200/80 bg-white/80 backdrop-blur-lg shadow-xl shadow-slate-200/50 relative overflow-hidden animate-fade-in">
            ...
            <div className="space-y-4">
              ...
              <p className="text-slate-600 max-w-md mx-auto text-sm md:text-base leading-relaxed font-medium">
                We are building the next generation DataLens workspace. Upload, clean, structure, and visualize your pipelines directly from this console.
              </p>
            </div>

            {/* Glowing Pipeline Loader Sim */}
            ...
            <div className="pt-4">
              <span className="px-6 py-3 rounded-2xl bg-slate-900 hover:bg-slate-800 text-white font-bold tracking-wider text-xs uppercase shadow-md shadow-slate-900/10 transition-all">
                Coming Soon
              </span>
            </div>
          </div>
